...
In ``lib.jinja``, we define this new macro ``files_switch``.

.. literalinclude:: ../template/lib.jinja
   :caption: /srv/saltstack/salt-formulas/ntp-saltstack-formula/ntp/lib.jinja
   :language: jinja
